 ...
 */
package eu.thingwave.arrowhead.fiware.demo.fiware;
...
public class FiwareClient {
    ...
    public int removeEntity(String entityId, String type) throws URISyntaxException, IOException {
        URIBuilder urlBuilder = new URIBuilder(orionBrokerURL+entitiesURL+"/"+entityId+"?type="+type);        
        return httpDELETE(urlBuilder.build().toString()).getStatusLine().getStatusCode();
    }
